					...
					<div class="rightContainer">
						<div class="react">
							...
							<div class="updownContainer">
								<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#000000" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16" display="inline" onclick="reactUp()">
								...
								<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#FFC700" class="bi bi-hand-thumbs-up-fill" viewBox="0 0 16 16" display="none">
								...
								<span class="upNumber">3</span>
								&nbsp;&nbsp;
								<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#000000" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16" display="inline" onclick="reactDown()">
						...
						<div class="inputComment">
							...
							<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="rgba(0,0,0,.75)" class="bi bi-send" viewBox="0 0 16 16" onclick="commentUpload()">
	...
	<!-- <div class="postContainer">
		...
		<div class="posting">
			...
			<div class="contentWrap">
				<div class="leftContainer">
					<div class="photo">
						<img src="resources/img/salad.jpg">
					</div>
				</div>
				<div class="rightContainer">
					<div class="react">
						<div class="content">오늘 먹은 저녁</div>
						<div class="updownContainer">
					...
					<div class="inputComment">
						...
						<input type="text" placeholder="댓글을 입력하세요">
						<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-send" viewBox="0 0 16 16" onclick="commentUpload()">
						  <path d="M15.854.146a.5.5 0 0 1 .11.54l-5.819 14.547a.75.75 0 0 1-1.329.124l-3.178-4.995L.643 7.184a.75.75 0 0 1 .124-1.33L15.314.037a.5.5 0 0 1 .54.11ZM6.636 10.07l2.761 4.338L14.13 2.576 6.636 10.07Zm6.787-8.201L1.591 6.602l4.339 2.76 7.494-7.493Z"/>
						</svg>
					</div>
