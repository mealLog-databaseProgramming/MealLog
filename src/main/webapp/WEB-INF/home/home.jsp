					...
					<div class="rightContainer">
						<div class="react">
							...
							<div class="updownContainer">
								...
								<c:if test="${feedDAO.isUserReactUp(currUserId, feed.getFeedId()) eq 0}">
								...
								<!-- 눌렀다면 -->
								<c:if test="${feedDAO.isUserReactUp(currUserId, feed.getFeedId()) eq 1}">
								...
								<!-- 눌렀다면 -->
								<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#FFC700" class="bi bi-hand-thumbs-down-fill" viewBox="0 0 16 16" display="none" value="<%=currUserId%>/<%=feed.getFeedId()%>">
