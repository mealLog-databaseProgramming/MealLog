...
<form id="profile_edit" action="/statupdate" class="profile" method="post" enctype="multipart/form-data">
	<div class="img">
		<img class="preview"/>
	...
	<div class="info">
		<input type="text" class="name" name="uname" placeholder="이름을 입력하세요" value="${uname}"></input>
