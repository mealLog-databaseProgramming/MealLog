...
<head>
	...
	<link rel="stylesheet" href="resources/css/home/home_2.css"/>
...
<body>
	...
	<div class="postContainer">
		...
		<div class="posting">
			...
			<!-- chart.js 한 페이지에 여러개 안들어가는 오류 -> 그냥 html, css로 변경 예정 -->
			...
			<div class="modal-dialog modal-lg">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h1 class="modal-title fs-5" id="exampleModalLabel">게시물 등록</h1>
			      ...
			      <div class="modal-body">
			      	...
			      	<div class="foodContainer">
				      <div class="food" onclick="deleteFood()">
				      	토마토
    ...
    <!-- <script>
        System.import('resources/js/home/app.js');
    </script>	 -->
